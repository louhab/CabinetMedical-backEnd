 ...
 */
final class Version20230422230653 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE SEQUENCE nationnalite_id_seq INCREMENT BY 1 MINVALUE 1 START 1');
        ...
        $this->addSql('CREATE TABLE consultation (id INT NOT NULL, patient_id INT NOT NULL, numero VARCHAR(255) NOT NULL, observation VARCHAR(255) NOT NULL, montant DOUBLE PRECISION NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE medcin (id INT NOT NULL, specilite1_id INT NOT NULL, categorie_id INT NOT NULL, nationalitie_id INT NOT NULL, matricule VARCHAR(255) NOT NULL, nom VARCHAR(255) NOT NULL, prenom VARCHAR(255) NOT NULL, date_naissance DATE DEFAULT NULL, adress VARCHAR(255) NOT NULL, ville VARCHAR(255) NOT NULL, tel VARCHAR(255) NOT NULL, gsm VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, fax VARCHAR(255) DEFAULT NULL, specialite VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_B49ACC864E0FED04 ON medcin (specilite1_id)');
        $this->addSql('CREATE INDEX IDX_B49ACC86BCF5E72D ON medcin (categorie_id)');
        $this->addSql('CREATE INDEX IDX_B49ACC86E9E34E45 ON medcin (nationalitie_id)');
        $this->addSql('CREATE TABLE modereg (id INT NOT NULL, code VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE TABLE nationnalite (id INT NOT NULL, code VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE TABLE rdv (id INT NOT NULL, horaire_id INT NOT NULL, patient_id INT NOT NULL, date_rdv DATE NOT NULL, observation VARCHAR(255) NOT NULL, numero INT NOT NULL, annee INT NOT NULL, date_consultation DATE NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE reglement (id INT NOT NULL, patient_id INT NOT NULL, modereg_id INT NOT NULL, numero INT NOT NULL, date_reglement DATE NOT NULL, mode_regelement VARCHAR(255) NOT NULL, montant DOUBLE PRECISION NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('ALTER TABLE medcin ADD CONSTRAINT FK_B49ACC864E0FED04 FOREIGN KEY (specilite1_id) REFERENCES specialite (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        ...
        $this->addSql('ALTER TABLE medcin ADD CONSTRAINT FK_B49ACC86E9E34E45 FOREIGN KEY (nationalitie_id) REFERENCES nationnalite (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        ...
        $this->addSql('ALTER TABLE patient ADD CONSTRAINT FK_1ADAD7EB1B063272 FOREIGN KEY (nationalite_id) REFERENCES nationnalite (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP SEQUENCE nationnalite_id_seq CASCADE');
        ...
        $this->addSql('ALTER TABLE medcin DROP CONSTRAINT FK_B49ACC864E0FED04');
        $this->addSql('ALTER TABLE medcin DROP CONSTRAINT FK_B49ACC86BCF5E72D');
        $this->addSql('ALTER TABLE medcin DROP CONSTRAINT FK_B49ACC86E9E34E45');
